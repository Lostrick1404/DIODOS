...
python scripts/BJT-gen-curvas-caracteristicas.py
# ... etc.
```
...
> **Regla:** Los scripts viven en `scripts/`. Las imágenes generadas se guardan en el `media/generated/` de cada módulo correspondiente. Nunca mezclar scripts con imágenes. Cada carpeta `generated/` debe incluir un `image-metadata.json`.
