...
> Registro centralizado de todos los scripts Python en `scripts/`, las imágenes que generan y los documentos que las referencian.
>
...
| Campo | Valor |
|-------|-------|
| **Script** | `scripts/DIO-gen-curva-iv.py` |
...
| Campo | Valor |
|-------|-------|
| **Script** | `scripts/DIO-gen-curva-temperatura.py` |
| **Módulo** | `DIO` — 01-Circuitos-Diodos |
...
| Campo | Valor |
|-------|-------|
| **Script** | `scripts/DIO-gen-curva-temperatura-split.py` |
| **Módulo** | `DIO` — 01-Circuitos-Diodos |
...
| Campo | Valor |
|-------|-------|
| **Script** | `scripts/DIO-gen-esquematico-pequena-senal.py` |
| **Módulo** | `DIO` — 01-Circuitos-Diodos |
...
| Campo | Valor |
|-------|-------|
| **Script** | `scripts/DIO-gen-pequena-senal.py` |
| **Módulo** | `DIO` — 01-Circuitos-Diodos |
...
| Campo | Valor |
|-------|-------|
| **Script** | `scripts/DIO-gen-recta-carga-circuito.py` |
| **Módulo** | `DIO` — 01-Circuitos-Diodos |
...
| Campo | Valor |
|-------|-------|
| **Script** | `scripts/DIO-gen-ejercicio-recta-carga.py` |
| **Módulo** | `DIO` — 01-Circuitos-Diodos |
...
| Campo | Valor |
|-------|-------|
| **Script** | `scripts/DIO-gen-rectificador-media-onda-esquema.py` |
| **Módulo** | `DIO` — 01-Circuitos-Diodos |
...
| Campo | Valor |
|-------|-------|
| **Script** | `scripts/DIO-gen-rectificador-media-onda-formas-onda.py` |
| **Módulo** | `DIO` — 01-Circuitos-Diodos |
...
| Campo | Valor |
|-------|-------|
| **Script** | `scripts/DIO-gen-nota4-rectificador-transformador.py` |
| **Módulo** | `DIO` — 01-Circuitos-Diodos |
...
| Campo | Valor |
|-------|-------|
| **Script** | `scripts/DIO-gen-nota5-rectificador-onda-completa-central.py` |
| **Módulo** | `DIO` — 01-Circuitos-Diodos |
...
| Campo | Valor |
|-------|-------|
| **Script** | `scripts/DIO-gen-nota6-rectificador-puente.py` |
| **Módulo** | `DIO` — 01-Circuitos-Diodos |
...
| Campo | Valor |
|-------|-------|
| **Script** | `scripts/DIO-gen-nota7-fourier-armonicos.py` |
| **Módulo** | `DIO` — 01-Circuitos-Diodos |
...
| Campo | Valor |
|-------|-------|
| **Script** | `scripts/DIO-gen-nota7-filtro-inductivo.py` |
| **Módulo** | `DIO` — 01-Circuitos-Diodos |
...
| Campo | Valor |
|-------|-------|
| **Script** | `scripts/DIO-gen-nota8-recortadores.py` |
| **Módulo** | `DIO` — 01-Circuitos-Diodos |
...
| Campo | Valor |
|-------|-------|
| **Script** | `scripts/DIO-gen-duplicador-voltaje.py` |
| **Módulo** | `DIO` — 01-Circuitos-Diodos |
...
| Campo | Valor |
|-------|-------|
| **Script** | `scripts/DIO-gen-duplicador-voltaje-horizontal.py` |
| **Módulo** | `DIO` — 01-Circuitos-Diodos |
...
| Campo | Valor |
|-------|-------|
| **Script** | `scripts/DIO-gen-curva-zener.py` |
| **Módulo** | `DIO` — 01-Circuitos-Diodos |
...
| Campo | Valor |
|-------|-------|
| **Script** | `scripts/DIO-gen-zener-regulador.py` |
| **Módulo** | `DIO` — 01-Circuitos-Diodos |
...
| Campo | Valor |
|-------|-------|
| **Script** | `scripts/BJT-gen-nota5-diagrama-polarizacion-divisor.py` |
...
| Campo | Valor |
|-------|-------|
| **Script** | `scripts/BJT-gen-emisor-comun-polarizacion-fija.py` |
| **Módulo** | `BJT` — 02-Transistor-BJT |
...
| Campo | Valor |
|-------|-------|
| **Script** | `scripts/BJT-gen-malla-entrada-vbe.py` |
| **Módulo** | `BJT` — 02-Transistor-BJT |
...
| Campo | Valor |
|-------|-------|
| **Script** | `scripts/BJT-gen-ejemplo-punto-operacion-ec.py` |
| **Módulo** | `BJT` — 02-Transistor-BJT |
...
| Campo | Valor |
|-------|-------|
| **Script** | `scripts/BJT-gen-switch-corte-saturacion.py` |
| **Módulo** | `BJT` — 02-Transistor-BJT |
...
| Campo | Valor |
|-------|-------|
| **Script** | `scripts/BJT-gen-curvas-caracteristicas.py` |
| **Módulo** | `BJT` — 02-Transistor-BJT |
...
| Campo | Valor |
|-------|-------|
| **Script** | `scripts/BJT-gen-base-comun-esquema.py` |
| **Módulo** | `BJT` — 02-Transistor-BJT |
...
| Campo | Valor |
|-------|-------|
| **Script** | `scripts/BJT-gen-base-comun-entrada.py` |
| **Módulo** | `BJT` — 02-Transistor-BJT |
...
| Campo | Valor |
|-------|-------|
| **Script** | `scripts/BJT-gen-lcapy-configuraciones.py` |
| **Módulo** | `BJT` — 02-Transistor-BJT |
...
| Campo | Valor |
|-------|-------|
| **Script** | `scripts/FET-gen-curva-transferencia.py` |
...
| Campo | Valor |
|-------|-------|
| **Script** | `scripts/AMP-gen-respuesta-frecuencia.py` |
...
| Campo | Valor |
|-------|-------|
| **Script** | `scripts/PRO-gen-fuente-alimentacion.py` |
